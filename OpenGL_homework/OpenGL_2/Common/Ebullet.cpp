...
Ebullet::Ebullet()
{
	OnUse = false;
	Exact = false;
	m_Points[0] = vec4( -0.15f,  0.15f, 0.0f, 1.0f);  //1
	m_Points[1] = vec4(  0.15f,  0.15f, 0.0f, 1.0f);
	m_Points[2] = vec4(  0.15f, -0.15f, 0.0f, 1.0f);
	m_Points[3] = vec4(0.15f, -0.15f, 0.0f, 1.0f);    //2
	m_Points[4] = vec4(-0.15f, -0.15f, 0.0f, 1.0f);
	m_Points[5] = vec4(-0.15f, 0.15f, 0.0f, 1.0f);
